...
if __name__ == "__main__":
    ...
    ratings = pd.read_csv('../books/BX-Book-Ratings.csv', delimiter=";", encoding="latin1")
    ratings.columns = ['userId', 'ISBN', 'bookRating']

    users = pd.read_csv('../books/BX-Users.csv', delimiter=";", encoding="latin1")
    users.columns = ['userId', 'location', 'age']

    books = pd.read_csv('../books/BX-Books.csv', delimiter=";", encoding="latin-1", error_bad_lines=False)
