...
if __name__ == "__main__":
    ...
    if(user_binary_tests_cond):
        ...
        pyplot.ylim(0, 1)
        pyplot.savefig("results/precision.png", dpi=150)
        ...
        pyplot.ylim(0, 1)
        pyplot.savefig("results/recall.png", dpi=150)
        pyplot.close()
    ...
    if(user_expl_tests_cond):
        ...
        pyplot.ylabel("Precision")
        pyplot.ylim(0, 1)
        pyplot.savefig("results/Explicit_precision.png", dpi=150)
        ...
        pyplot.ylabel("Recall")
        pyplot.ylim(0, 1)
        pyplot.savefig("results/Explicit_recall.png", dpi=150)
        ...
        pyplot.savefig("results/Explicit_ListValueDifference.png", dpi=150)
        ...
        pyplot.savefig("results/Explicit_DiscountedComulativeGain.png", dpi=150)
